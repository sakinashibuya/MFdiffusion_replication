...
\subsection*{Main part}
\begin{itemize}
  \item 3: Declare a variable ``netstats'' which contains information of networks in each village (for the function \textt{persistent}, see \href{https://www.mathworks.com/help/matlab/ref/persistent.html}{here})
